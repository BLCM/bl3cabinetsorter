...
<br/>
<em>OHL or B3HM (local file): Right click and "Save Link As"<br/>
OHL (web loading): Create a shortcut by dragging into a folder<br/>
B3HM (web loading): Right click and "Copy Link"</em>
{%- if mod.pakfile %}
<br/>
